...
class _GradientSplashScreenState extends BaseState<GradientSplashScreen> with SingleTickerProviderStateMixin {
  ...
  Future<ApiResponse<List<ResourceItem>>> fetchResources() async {
    final response = await ApiService().sendRequest(getResourcesApi, method: 'GET');
  ...
  Widget build(BuildContext context) {
    return BlocListener<ApiCubit<ApiResponse<List<ResourceItem>>>, ApiState<ApiResponse<List<ResourceItem>>>>(
